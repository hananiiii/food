  ...
  return (
    <div className='bg-[#0000007d] w-full h-screen fixed left-0 top-0 z-20' onClick={()=>setShowCart(false)}>
              <div className='max-w-[400px] w-full h-full bg-white absolute right-0 top-0 p-6' onClick={(e)=>e.stopPropagation()}>
                   ...
                   <button className='bg-green-900 text-white text-center w-full rounded-3xl py-2 mb-4 mt-4'>View Cart</button>
                   <button className='bg-green-900 text-white text-center w-full rounded-3xl py-2 mb-4 mt-4'>Checkout</button>
              </div>
