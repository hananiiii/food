...
const ProductCard:React.FC<propsType> = ({img,name,price}) => {
  ...
  return (
    <div className='border border-gray-200 hover:border-gray-300 hover:scale-105 transition-transform rounded-lg relative'>
          ...
          <div className='space-y-2 realative p-4'>
            ...
            <button className='absolute -top-4 right-2 bg-title_color text-text_color text-[28px] w-[50px] h-[50px] rounded-full grid place-items-center cursor-pointer' onClick={addProductToCart}>
